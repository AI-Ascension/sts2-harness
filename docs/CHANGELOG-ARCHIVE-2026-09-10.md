# Changelog archive: 2026-09-10 bounded-campaign wave

This file preserves the closed 2026-09-10 bounded-campaign wave that was moved out of
[`CHANGELOG-ARCHIVE.md`](CHANGELOG-ARCHIVE.md) when that archive reached its own preferred Markdown
size budget. Entries are unchanged from the revision that introduced them; this file is a verbatim
record, not a supported release or a second normative changelog. Active development continues in
