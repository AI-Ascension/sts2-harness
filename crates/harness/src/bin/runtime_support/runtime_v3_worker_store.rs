...
#[derive(Clone)]
pub(super) struct SharedExecutionStore {
...
pub(super) fn try_lock(store: &SharedExecutionStore) -> Result<StoreLease<'_>, String> {
...
pub(super) fn try_lock_recovery(store: &SharedExecutionStore) -> Result<StoreLease<'_>, String> {
...
pub(super) fn try_lock_quarantine(store: &SharedExecutionStore) -> Result<StoreLease<'_>, String> {
    try_lock_recovery(store)
}

pub(super) fn try_lock_close(store: &SharedExecutionStore) -> Result<StoreLease<'_>, String> {
    try_lock_recovery(store)
}

pub(super) fn begin_quarantine(store: &SharedExecutionStore) -> Result<bool, String> {
    store.begin_quarantine()
}

pub(super) fn finish_quarantine(store: &SharedExecutionStore) {
