...
impl DurableHandle {
    ...
    pub(super) fn validate_pending_action_identity(&self) -> Result<(), String> {
        ...
        for operation in pending {
            ...
            let action = super::super::runtime_v3_parse::action_from_payload(
            ...
            if operation.intent.action_kind.as_deref()
                != Some(super::super::runtime_v3_wire::action_kind_name(
                    action.kind(),
                ))
                || super::super::runtime_v3_wire::canonical_action_digest(
                    action.action_id(),
                    payload,
                )
                .map_err(|error| {
