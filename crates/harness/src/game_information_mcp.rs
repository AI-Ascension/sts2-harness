...
#[path = "game_information_mcp_arguments.rs"]
mod arguments;
#[path = "game_information_mcp_bootstrap.rs"]
mod bootstrap;
pub use bootstrap::call_live_observation_bootstrap_mcp;
    ...
    F: FnOnce(u64, Value) -> Result<Value, LookupError>,
{
    ...
    let arguments = arguments::arguments(context, request)?;
